...
std::shared_ptr<SFML::SFMLPlayer> SFML::EntityFactory::createPlayer()
{
        ...
        return std::make_shared<SFML::SFMLPlayer>(lane, size, lanePositions, speed, speedUpFactor, yellingRange,
                                                  sprite_path);
}
...
std::set<std::shared_ptr<SFML::SFMLCompetingHiker>> SFML::EntityFactory::createCompetingHikers(unsigned int player_lane)
{
        ...
        for (unsigned int i = 0; i < 4; i++) {
                if (i != player_lane)
                        competingHikers.insert(std::make_shared<SFML::SFMLCompetingHiker>(i, size, lanePositions, speed,
                                                                                          speedUpFactor, sprite_path));
        }
...
std::shared_ptr<SFML::SFMLMovingEnemy> SFML::EntityFactory::createMovingEnemy(unsigned int lane, double y_pos,
                                                                              double speed)
{
        ...
        auto enemy =
            std::make_shared<SFML::SFMLMovingEnemy>(lane, size, lanePositions, speed, speedUpFactor, sprite_path);
        enemy->setYposition(y_pos);
        return enemy;
}
...
std::shared_ptr<SFML::SFMLFinishLine> SFML::EntityFactory::createFinishLine()
{
        ...
        std::shared_ptr<SFML::SFMLFinishLine> finishLine =
            std::make_shared<SFML::SFMLFinishLine>(sprite_path, position, size, imageCoordinate);
...
std::set<std::shared_ptr<SFML::SFMLPassiveItem>> SFML::EntityFactory::createPassiveItem()
{
        ...
        std::vector<std::vector<int>> v = {first_place_rewards, second_place_rewards, third_place_rewards,
                                           fourth_place_rewards};
