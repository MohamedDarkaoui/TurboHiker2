...
const TurboHiker::Position2D &TurboHiker::Entity::getPosition() const {
    return position;
}
...
const std::pair<double, double> &TurboHiker::Entity::getSize() const {
    return size;
}

unsigned int TurboHiker::Entity::getLane() const {
    return lane;
}

const std::vector<double> &TurboHiker::Entity::getLanePositionsX() const {
    return lanePositionsX;
}

void TurboHiker::Entity::setLane(unsigned int _lane) {
    TurboHiker::Entity::lane = _lane;
}


void TurboHiker::Entity::setPosition(const Position2D &pos) {
    TurboHiker::Entity::position = pos;
}
