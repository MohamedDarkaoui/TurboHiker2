...
TurboHiker::PassiveItem::PassiveItem(unsigned int lane, std::pair<double, double>& size,
...
void TurboHiker::PassiveItem::giveReward(std::shared_ptr<CompetingHiker>& competitor,
